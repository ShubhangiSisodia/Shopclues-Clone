...
function renderProduct(){
    ...
    <div id="productimg">
        ...
        <div id="prodDesc">
            ...
            <p class="lighttext" id="fsmall">Inclusive of all taxes</p>
            
            <div id="supdisc"><img src="./superDiscount.png" alt=""></div>
            
            <p class="totheleft">*All discounts can be availed in the cart page</p>
            <div id="Extras">
            <img src="https://images.shopclues.com/images/ui/loyalty_diamond.png" alt="">
                <h4>Extra CluesBucks+</h4>
            ...
            <div id="offerimg"><img src="./offers.png" alt=""></div>
            <div id="type">
                <h3>Type 7</h3>
                <div id="buttons">
